      ...
      txn.executeSql(
        ...
        (tx, res) => {
          ...
          if (res.rows.length == 0) {
            ...
            txn.executeSql(
              'CREATE TABLE IF NOT EXISTS table_alarm(alarmID INTEGER PRIMARY KEY AUTOINCREMENT, isEnabled BOOLEAN, date VARCHAR(30), mission VARCHAR(30), sound VARCHAR(30))',
              []
            );
          } else {
